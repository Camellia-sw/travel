<template>
  <div class="sidebar-container" :class="{ 'is-collapsed': isCollapsed }">
    <div class="logo">
      <span class="logo-icon"><el-icon :size="24"><Van style="color: #409EFF;" /></el-icon></span>
      <span class="logo-text" v-show="!isCollapsed">旅游推荐系统</span>
    </div>
    <div class="menu-wrapper">
      <el-menu :default-active="activeMenu" :collapse="isCollapsed" :collapse-transition="false" mode="vertical" class="sidebar-menu"
        ...
        <!-- 固定菜单项 -->
        <el-menu-item index="/back/manager">
