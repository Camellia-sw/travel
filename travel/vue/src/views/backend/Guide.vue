d:\IdeaProjects\travel\vue\src\views\backend\Guide.vue
<template>
        ...
        <el-table-column label="作者" width="180">
          <template #default="scope">
            <div class="author-info">
              <el-avatar :src="scope.row.avatar ? (baseAPI + scope.row.avatar) : ''" size="small" />
              <span class="author-name">{{ scope.row.username || ('用户' + scope.row.userId) }}</span>
            </div>
          </template>
        </el-table-column>
    ...
    >
      <div class="guide-preview" v-if="previewGuideData">
        ...
        <div class="preview-info">
          <span>作者: {{ previewGuideData.username || ('用户' + previewGuideData.userId) }}</span>
